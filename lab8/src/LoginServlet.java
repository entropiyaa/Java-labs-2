...
public class LoginServlet extends ChatServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        pw.println("<form action='/lab8_war_exploded/login' method='post'>Input name: <input type='text' name='name' value=''><input type='submit' value='Enter chat'>");
    ...
    private String processLogonAttempt(String name, HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if (aUser.getSessionId().equals(sessionId) ||
            ...
            return "Sorry, but name <strong>" + name + "</strong> is already taken by someone. Please choose a different name!";
        }
    }
}
